...
## 공공데이터란?
> 공공데이터는 ‘중앙부처, 지자체, 공공기관이 생산하고 보유 및 관리하고 있는 교통, 기상, 의료, 경제, 환경 등의 모든 데이터를 의미합니다. 
> 버스 실시간 도착정보 서비스,기상청 어플리케이션,한국석유공사의 전국 주유소 유가정보 등이 공공데이터라고 할 수 있습니다.  
> 법률적인 측면에서 2013년에 제정되고 2014년에 개정된 공공데이터의 제공 및 이용활성화에 대한 법률의 제 1장 2조의 정의하고 있습니다. ‘공공데이터’란 데이터베이스, 전자화된 파일 등 공공기관이 법령 등에서 정하는 목적을 위하여 생성 또는 취득하여 관리하고 있는 광(光) 또는 전자적 방식으로 처리된 자료 또는 정보를 말합니다.’  
